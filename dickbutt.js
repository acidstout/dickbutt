...
(function () {
	...
	for (var i = 0; i < dickbutts; i++) {
		...
		/* the actual draw */
		document.body.innerHTML += '<img style="position:absolute;min-width:'+imgMinWidth+'px;max-width:'+imgMaxWidth+'px;top:'+randY+'px;left:'+randX+'px; width:'+randW+'px;" src=\'data:image/svg+xml;utf8,' + inlineSvg + '\' alt=""/>';
	}
}());